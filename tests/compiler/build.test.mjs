...
assert.match(baseCss, /\.reveal :is\(\.dz-card, \.dz-sequence-node\) :is\(ul, ol\) \{/);
assert.match(baseCss, /padding-left: 1\.25rem;/);
assert.match(baseCss, /\.reveal :is\(\.dz-card, \.dz-sequence-node\) li \{/);
assert.match(baseCss, /padding-left: 0\.15em;/);
